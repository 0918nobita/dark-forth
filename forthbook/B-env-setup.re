...
配列・スタックといった基本的なデータ構造についても説明を省いている。
...
FORTH が他のプログラマに最初に公開されたのは 1970 年代で、
...
== 役立つリファレンス
 ...
 : iMops-forth @Wiki
    @<href>{https://w.atwiki.jp/imops-forth/}@<br>{}FORTH からの派生言語である「iMops」について様々な記事が公開されている Wiki
